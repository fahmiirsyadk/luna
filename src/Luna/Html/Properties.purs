...
import Luna.Html.Core (class ToPropValue, IProp)
import Luna.Html.Core as Html
...
autocomplete ∷ ∀ r i. Boolean → IProp (autocomplete ∷ I.AutocompleteType | r) i
autocomplete = Html.prop "autocomplete" <<< if _ then I.AutocompleteOn else I.AutocompleteOff
