...
unHtml :: forall i. Html i -> HtmlV i
unHtml (Html v) = v

wrapHtml :: forall i. HtmlV i -> Html i
wrapHtml = Html
...
instance autocompleteTypeToPropValue :: ToPropValue AutocompleteType where
  toPropValue = P.propFromString <<< renderAutocompleteType
